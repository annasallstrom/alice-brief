...
% \footnote{Note to ourselves: possible analogy to genus and species claims:
% once the genus is disclosed, can’t patent individual species within it,
% because allowing otherwise would encourage a rush to cover the genus with
% individual patents, making the genus patent less valuable.  (In the analogy
% the genus patent is the public domain idea.)}
%
% NOTE: a citation of * (asterisk) means cite the last inline case, but omit
% repeating the title.
...
* at 1545}. But this is like saying that a television screen is
